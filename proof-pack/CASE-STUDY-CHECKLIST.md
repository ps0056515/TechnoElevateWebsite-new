...
- [ ] Your role documented (build / augment / support / migration)
...
- [ ] Reference call contact identified (if Tier A)
...
- [ ] Saved to `evidence/03-case-studies/{case_id}/`
...
**Can we show this case in an enterprise pitch with metrics?**

→ All Tier A boxes checked + at least one outcome metric verified.

**Can we keep it on the website but soften metrics?**

→ Tier B: remove specific numbers, keep qualitative outcomes.

**Should we anonymize?**

→ Tier C: change client name to "Leading Indian bank" etc.
