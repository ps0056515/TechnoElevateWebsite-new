# Proof manifest - Tata AIA Life Insurance

**Case ID:** `talic`  
**Website:** `/case-studies/talic`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/talic/`
...
| --- | ------------------------------------------------ | --------------------------------------- | --------- |
| 1   | Automated backend payment triggers               | Internal KPI / client email / load test | ☐         |
| 2   | Reduced manual labor across claim processing     | Internal KPI / client email / load test | ☐         |
| 3   | Higher settlement accuracy and faster turnaround | Internal KPI / client email / load test | ☐         |
