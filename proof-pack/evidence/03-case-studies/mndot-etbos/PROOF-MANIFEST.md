# Proof manifest — Minnesota DOT

**Case ID:** `mndot-etbos`  
**Website:** `/case-studies/mndot-etbos`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/mndot-etbos/`
...
|---|------------------|---------------|-----------|
| 1 | Automated E-ZPass lifecycle across Minnesota | Internal KPI / client email / load test | ☐ |
| 2 | Real-time account balance updates per transaction | Internal KPI / client email / load test | ☐ |
| 3 | Rule-based violation detection and management | Internal KPI / client email / load test | ☐ |
| 4 | Seamless cross-team operational workflow | Internal KPI / client email / load test | ☐ |
