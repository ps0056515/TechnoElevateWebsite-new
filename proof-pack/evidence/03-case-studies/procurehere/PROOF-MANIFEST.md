# Proof manifest — Privasia (ProcureHere)

**Case ID:** `procurehere`  
**Website:** `/case-studies/procurehere`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/procurehere/`
...
|---|------------------|---------------|-----------|
| 1 | Multi-tenant enterprise SaaS at scale | Internal KPI / client email / load test | ☐ |
| 2 | Modern microservices architecture live | Internal KPI / client email / load test | ☐ |
| 3 | Enhanced security, compliance and auditability | Internal KPI / client email / load test | ☐ |
| 4 | Seamless enterprise system integration | Internal KPI / client email / load test | ☐ |
