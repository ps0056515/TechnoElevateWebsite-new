# Proof manifest - Industrial IoT Client

**Case ID:** `iiot`  
**Website:** `/case-studies/iiot`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/iiot/`
...
| --- | ---------------------------------------------------- | --------------------------------------- | --------- |
| 1   | Real-time industrial operational dashboards          | Internal KPI / client email / load test | ☐         |
| 2   | ML-driven operational insights and anomaly detection | Internal KPI / client email / load test | ☐         |
| 3   | Customizable KPI reporting for operations teams      | Internal KPI / client email / load test | ☐         |
| 4   | Secure multi-role access management                  | Internal KPI / client email / load test | ☐         |
