# Proof manifest - CARS24 (Loans24)

**Case ID:** `saarathi`  
**Website:** `/case-studies/saarathi`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/saarathi/`
...
| --- | --------------------------------------- | --------------------------------------- | --------- |
| 1   | End-to-end lending lifecycle in one app | Internal KPI / client email / load test | ☐         |
| 2   | Granular ABAC-based access control      | Internal KPI / client email / load test | ☐         |
| 3   | Faster decisioning and disbursal cycle  | Internal KPI / client email / load test | ☐         |
| 4   | Compliance-ready agent-led origination  | Internal KPI / client email / load test | ☐         |
