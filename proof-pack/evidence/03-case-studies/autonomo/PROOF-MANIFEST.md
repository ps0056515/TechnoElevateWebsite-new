# Proof manifest — Autonomo

**Case ID:** `autonomo`  
**Website:** `/case-studies/autonomo`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/autonomo/`
...
|---|------------------|---------------|-----------|
| 1 | Checkout-free retail experience live in stores | Internal KPI / client email / load test | ☐ |
| 2 | Computer vision-driven real-time product tracking | Internal KPI / client email / load test | ☐ |
| 3 | TAPNGO contactless payment integration | Internal KPI / client email / load test | ☐ |
| 4 | Frictionless customer entry and exit | Internal KPI / client email / load test | ☐ |
