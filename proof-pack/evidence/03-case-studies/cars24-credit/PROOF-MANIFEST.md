# Proof manifest — CARS24

**Case ID:** `cars24-credit`  
**Website:** `/case-studies/cars24-credit`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/cars24-credit/`
...
|---|------------------|---------------|-----------|
| 1 | Significant cost reduction vs. third-party scoring | Internal KPI / client email / load test | ☐ |
| 2 | Higher approval rates for new-to-credit segment | Internal KPI / client email / load test | ☐ |
| 3 | Fully in-house, scalable microservices stack | Internal KPI / client email / load test | ☐ |
| 4 | Real-time underwriting at CARS24 volume and scale | Internal KPI / client email / load test | ☐ |
