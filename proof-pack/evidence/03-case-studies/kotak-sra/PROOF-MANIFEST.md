...
**Case ID:** `kotak-sra`  
**Website:** `/case-studies/kotak-sra`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/kotak-sra/`
...
| --- | -------------------------------------------------- | --------------------------------------- | --------- |
| 1   | Automated 80–90% of branch SR volume               | Internal KPI / client email / load test | ☐         |
| 2   | Real-time high-value transaction approvals         | Internal KPI / client email / load test | ☐         |
| 3   | Full audit trail - zero untraceable authorizations | Internal KPI / client email / load test | ☐         |
| 4   | Dramatic reduction in branch back-office workload  | Internal KPI / client email / load test | ☐         |
