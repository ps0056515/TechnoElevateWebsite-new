# Proof manifest - Lloyds Banking Group

**Case ID:** `lloyds-ddrx`  
**Website:** `/case-studies/lloyds-ddrx`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/lloyds-ddrx/`
...
| --- | ------------------------------------------------------- | --------------------------------------- | --------- |
| 1   | SME suppliers unlock affordable early-payment liquidity | Internal KPI / client email / load test | ☐         |
| 2   | Dynamic routing to the best funding source              | Internal KPI / client email / load test | ☐         |
| 3   | New working-capital product line for Lloyds             | Internal KPI / client email / load test | ☐         |
| 4   | Reduced friction and cost across entire supply chain    | Internal KPI / client email / load test | ☐         |
