# Proof manifest - LegalDST

**Case ID:** `legaldst`  
**Website:** `/case-studies/legaldst`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/legaldst/`
...
| --- | --------------------------------------------------- | --------------------------------------- | --------- |
| 1   | Instant AI-powered legal case research              | Internal KPI / client email / load test | ☐         |
| 2   | LLM-generated answers with verified case references | Internal KPI / client email / load test | ☐         |
| 3   | Subscription-based revenue model live and operating | Internal KPI / client email / load test | ☐         |
| 4   | Modern chat-style UX built for practising lawyers   | Internal KPI / client email / load test | ☐         |
