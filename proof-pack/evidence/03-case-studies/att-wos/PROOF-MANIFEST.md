...
**Case ID:** `att-wos`  
**Website:** `/case-studies/att-wos`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/att-wos/`
...
|---|------------------|---------------|-----------|
| 1 | Reliable carrier-to-carrier ordering workflow | Internal KPI / client email / load test | ☐ |
| 2 | Support for all carrier types (CLECs, IXCs) | Internal KPI / client email / load test | ☐ |
| 3 | Regional-scale telecom ordering platform | Internal KPI / client email / load test | ☐ |
