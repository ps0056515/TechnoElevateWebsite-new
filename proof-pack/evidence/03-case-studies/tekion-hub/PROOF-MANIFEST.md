...
**Case ID:** `tekion-hub`  
**Website:** `/case-studies/tekion-hub`  
**Source:** `shared/cases.js`  
**Proof folder:** `evidence/03-case-studies/tekion-hub/`
...
|---|------------------|---------------|-----------|
| 1 | Single integration layer across all OEM partners | Internal KPI / client email / load test | ☐ |
| 2 | Near real-time bidirectional data sync | Internal KPI / client email / load test | ☐ |
| 3 | Eliminated point-to-point integration chaos | Internal KPI / client email / load test | ☐ |
| 4 | Secure, versioned, standardized data contracts | Internal KPI / client email / load test | ☐ |
