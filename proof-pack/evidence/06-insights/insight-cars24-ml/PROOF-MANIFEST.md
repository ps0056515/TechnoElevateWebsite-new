...
**Route:** `/insight-cars24-ml`  
**Title:** In-house ML credit scoring at production volume  
**Based on case:** `cars24-credit` (CARS24)
...
1. Complete proof pack: `../03-case-studies/cars24-credit/`
...
Review the live page at `/insight-cars24-ml` and list any **numbers or superlatives** - each needs a row in `METRICS-REGISTER.csv`.
