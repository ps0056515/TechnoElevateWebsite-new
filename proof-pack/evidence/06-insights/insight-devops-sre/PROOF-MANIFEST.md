...
**Route:** `/insight-devops-sre`  
**Title:** DevOps & SRE for regulated enterprise workloads  
**Based on case:** `verizon-mybiz` (Verizon)
...
1. Complete proof pack: `../03-case-studies/verizon-mybiz/`
...
Review the live page at `/insight-devops-sre` and list any **numbers or superlatives** - each needs a row in `METRICS-REGISTER.csv`.
