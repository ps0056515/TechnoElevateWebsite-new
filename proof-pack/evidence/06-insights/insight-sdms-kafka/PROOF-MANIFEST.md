...
**Route:** `/insight-sdms-kafka`  
**Title:** Monolith to Kafka: SDMS discount engine migration  
**Based on case:** `sdms` (Dalmia Bharat Cement)
...
1. Complete proof pack: `../03-case-studies/sdms/`
...
Review the live page at `/insight-sdms-kafka` and list any **numbers or superlatives** — each needs a row in `METRICS-REGISTER.csv`.
