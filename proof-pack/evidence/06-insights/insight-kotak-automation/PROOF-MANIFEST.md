...
**Route:** `/insight-kotak-automation`  
**Title:** Automating 80–90% of Branch Service Requests at Kotak  
**Based on case:** `kotak-sra` (Kotak Mahindra Bank)
...
1. Complete proof pack: `../03-case-studies/kotak-sra/`
...
Review the live page at `/insight-kotak-automation` and list any **numbers or superlatives** — each needs a row in `METRICS-REGISTER.csv`.
