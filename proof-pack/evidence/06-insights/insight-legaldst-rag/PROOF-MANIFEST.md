...
1. Complete proof pack: `../03-case-studies/legaldst/`
...
Review the live page at `/insight-legaldst-rag` and list any **numbers or superlatives** — each needs a row in `METRICS-REGISTER.csv`.
