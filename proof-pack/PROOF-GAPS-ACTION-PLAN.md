...
## Suggested website copy replacements
...
## Proof pack owner checklist (monthly)

- [ ] PROJECT-REGISTER.csv updated for new closed projects
- [ ] Expired certifications removed from website
- [ ] CLIENT-REFERENCE-MATRIX reviewed
- [ ] No newsroom item older than 12 months without refresh
- [ ] Tier A folders complete for top 6 cases
- [ ] SITE-CLAIMS-AUDIT.md status column updated
...
```
evidence/
├── 01-company/           ← TestYantra registration, org chart
├── 02-certifications/    ← CMMI, AWS, ISO PDFs
├── 03-case-studies/      ← One subfolder per case_id
├── 04-testimonials/      ← Signed quotes
└── 05-security/          ← SDLC policy, security questionnaire
```

Create subfolders for Tier A cases now:

- `evidence/03-case-studies/kotak-sra/`
- `evidence/03-case-studies/kotak-lcrms/`
- `evidence/03-case-studies/legaldst/`
- `evidence/03-case-studies/cars24-credit/`
- `evidence/03-case-studies/verizon-mybiz/`
- `evidence/03-case-studies/tekion-dms/`

Drop SOWs, architecture diagrams, and sign-offs into each folder as you collect them.
