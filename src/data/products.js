...
export const PRODUCTS = [
    ...
    useCases: [
      {
        ...
        desc: "AI calls leads, captures intent, and pushes scored outcomes to your CRM pipeline.",
      },
      {
        title: "Browser voice demo",
        desc: "Prospects talk to the bot on web - same stack as telephony, faster iteration for pilots.",
      },
      {
        title: "Webhook lead intake",
        desc: "Marketing forms and partner feeds land in Postgres with auditable stage transitions.",
      },
      {
        title: "Counsellor handoff",
        desc: "Warm transfers with full transcript context - no repeat questions for families.",
      },
    ],
    modules: [
      {
        title: "Voice service",
        desc: "WebSocket STT → LLM → TTS with static demo UI for sales and QA.",
      },
      {
        title: "Interview CRM API",
        desc: "FastAPI REST layer with JWT, roles, and admissions-specific entities.",
      },
      {
        title: "Worker plane",
        desc: "Celery + Redis for async jobs, retries, and scheduled outreach batches.",
      },
      {
        title: "Ops & deploy",
        desc: "Docker Compose profile for local parity and production-shaped environments.",
      },
    ],
    workflow: [
      "Lead ingested via webhook or CRM",
      "Voice bot qualifies & captures answers",
      "Pipeline stage updated in Postgres",
      "Counsellor notified for human close",
    ],
    features: [
  ...
  },
  {
    ...
    personas: [
      ...
      "Admission ops managers",
      "Field counsellors",
      "Platform owners",
    ],
    useCases: [
      {
        title: "Seasonal admission drives",
        desc: "Spin up voice campaigns per course intake with tenant-scoped quotas and scripts.",
      },
      {
        title: "Counsellor PWA",
        desc: "Mobile-first follow-up for counsellors in the field - calls, notes, next actions.",
      },
      {
        title: "Ops command center",
        desc: "Internal team monitors queue depth, failures, and SLA across all tenants.",
      },
      {
        title: "CRM widget embed",
        desc: "Drop AdmitIQ into existing institute sites for lead capture without rebuild.",
      },
    ],
    modules: [
      {
        title: "API & auth",
        desc: "NestJS 11, Swagger, JWT tenancy, Prisma on PostgreSQL.",
      },
      {
        title: "Orchestrator",
        desc: "BullMQ jobs for scheduling, retries, and campaign lifecycle.",
      },
      {
        title: "Voice worker",
        desc: "Dedicated worker for voice session simulation and live connect paths.",
      },
      {
        title: "Frontends",
        desc: "Admin, ops, counsellor, and CRM widget - React 19 + Vite.",
      },
    ],
    workflow: [
      "Lead webhook from LMS or ads",
      "Orchestrator queues voice touch",
      "Counsellor reviews outcome in PWA",
      "Conversion tracked per tenant",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      {
        title: "Mail-triggered agents",
        desc: "IMAP poll or Graph webhook kicks off triage, draft, or ticket-creation flows.",
      },
      {
        title: "Dev workflow bots",
        desc: "GitHub/GitLab/Jira/Azure DevOps actions from a single agent run.",
      },
      {
        title: "RAG + documents",
        desc: "Bridge to ai-services for enterprise retrieval - not a siloed chat UI.",
      },
      {
        title: "Human-in-the-loop",
        desc: "Approval queue before destructive or external-facing tool calls execute.",
      },
    ],
    modules: [
      {
        title: "LLM gateway",
        desc: "Chat, stream, failover, rate limits, and per-team budget tracking.",
      },
      {
        title: "Tool registry",
        desc: "GitHub, Slack, Confluence, web search, python_exec, email, and more.",
      },
      {
        title: "Execution engine",
        desc: "Sync runs or Celery async with execution IDs and status polling.",
      },
      {
        title: "Governance",
        desc: "Approvals, audit logs, marketplace flags, team tenancy.",
      },
    ],
    workflow: [
      "Define agent in YAML",
      "Attach tools & secrets",
      "Trigger via UI, API, or mail",
      "Approve if required → audit log",
    ],
    features: [
  ...
  },
  {
    ...
    personas: [
      ...
      "Content editors",
      "Growth marketers",
      "Learners (GRE/GMAT/IELTS)",
    ],
    useCases: [
      {
        title: "Competitive vocab portals",
        desc: "Branded study flows with streaks, lists, and exam-specific positioning.",
      },
      {
        title: "Content ops at scale",
        desc: "Editors maintain thousands of words in Sheets; devs import on schedule.",
      },
      {
        title: "Android distribution",
        desc: "Capacitor build pipeline documented for Play Store go-live.",
      },
      {
        title: "Rapid UX experiments",
        desc: "HTML-first core lets design iterations ship without native rebuilds.",
      },
    ],
    modules: [
      {
        title: "Learner portal",
        desc: "Responsive web app with ZupFly theme CSS and study modes.",
      },
      {
        title: "Sheets CMS",
        desc: "Export/import CSV pipeline for words, lists, and groups.",
      },
      {
        title: "Mobile packaging",
        desc: "Capacitor sync, assets, and Android Studio workflow.",
      },
      {
        title: "Go-live kit",
        desc: "Deployment, privacy policy, and store listing documentation.",
      },
    ],
    workflow: [
      "Edit content in Google Sheets",
      "Import to app data layer",
      "Deploy web + build Android",
      "Learners study on any device",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      {
        title: "Practitioner discussions",
        desc: "Threads, upvotes, filters - knowledge base that grows with the community.",
      },
      {
        title: "Tool discovery",
        desc: "Curated directory of real accessibility tools with outbound links and context.",
      },
      {
        title: "Events & workshops",
        desc: "Listings for meetups and training - central calendar for the community.",
      },
      {
        title: "NVDA lab guide",
        desc: "Step-by-step interactive checklist for screen-reader testing workflows.",
      },
    ],
    modules: [
      {
        title: "Community",
        desc: "Discussions, search, upvotes, and category filters.",
      },
      {
        title: "Resources & tools",
        desc: "Libraries with tagging and editorial structure.",
      },
      {
        title: "NVDA guide",
        desc: "Interactive checklist UX for manual testing.",
      },
      {
        title: "Identity",
        desc: "JWT sessions, Google OAuth, forgot-password via SMTP.",
      },
    ],
    workflow: [
      "Member signs up (OAuth or email)",
      "Posts, upvotes, bookmarks",
      "Uses NVDA guide during audits",
      "Discovers events and tools",
    ],
    features: [
  ...
  },
  {
    ...
    useCases: [
      {
        title: "GRE synonym groups",
        desc: "Clustered study aligned with how high-scorers memorise vocabulary.",
      },
      {
        title: "Dictionary drills",
        desc: "Flat lists for last-mile revision before exam day.",
      },
      {
        title: "Mobile-first prep",
        desc: "Notifications and TTS on Android for commute-friendly learning.",
      },
      {
        title: "White-label ready",
        desc: "Ship under ZupFly or partner brands with shared CMS.",
      },
    ],
    modules: [
      {
        title: "Study engine",
        desc: "Group mode, dictionary mode, progress and spaced repetition hooks.",
      },
      {
        title: "Sheets CMS",
        desc: "Words, WordLists, Groups, DictionaryWords CSV round-trip.",
      },
      {
        title: "Capacitor Android",
        desc: "Plugins for TTS, notifications, splash, assets.",
      },
      {
        title: "Store ops",
        desc: "Go-live checklist and privacy policy assets.",
      },
    ],
    workflow: [
      "Content team updates Sheets",
      "Import builds data JSON",
      "Learner studies on web or app",
      "Push updates without native code changes",
    ],
    features: [
  ...
  },
  {
    ...
    personas: [
      ...
      "Recruiting teams",
      "Tech interview coaches",
    ],
    useCases: [
      {
        title: "Candidate mock loop",
        desc: "Setup wizard → live session → debrief with 7-day action plan.",
      },
      {
        title: "IDE copilot",
        desc: "Coding rounds with hints and execution against hidden tests.",
      },
      {
        title: "Recruiter pipeline",
        desc: "Jobs, candidates, session status, debrief access per role.",
      },
      {
        title: "Behavioral STAR",
        desc: "Structured behavioral coach separate from technical tracks.",
      },
    ],
    modules: [
      {
        title: "Candidate app",
        desc: "Dashboard, setup, live session, debrief, assessments.",
      },
      {
        title: "Code runner",
        desc: "Isolated execution service for technical rounds.",
      },
      {
        title: "Recruiter console",
        desc: "Pipeline, job config, candidate detail with rubric view.",
      },
      {
        title: "Intelligence layer",
        desc: "JD/resume parse, gap map, Tavily company intel optional path.",
      },
    ],
    workflow: [
      "Upload JD + resume",
      "AI plans rounds & questions",
      "Live mock with copilot",
      "Debrief → recruiter pipeline update",
    ],
    features: [
...
export const PORTFOLIO_STATS = [
  {
    value: "7",
    label: "Product lines",
    sub: "Voice · agents · ed-tech · hiring",
  },
  {
    value: "AI-first",
    label: "Core stack",
    sub: "LLM, RAG, voice & orchestration",
  },
  {
    value: "Full-stack",
    label: "Ship path",
    sub: "Web · API · mobile · workers",
  },
