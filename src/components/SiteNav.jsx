        ...
        <div className="nav-inner">
          ...
          <ul className="nav-menu" id="navMenu">
            ...
            >
              ...
              <MegaCols>
                <div>
                  ...
                  <MegaLink to="/ai-llm-rag">
                    LLM &amp; RAG Engineering
                  </MegaLink>
                  <MegaLink to="/ai-agentic">
                    Agentic Business Automation
                  </MegaLink>
                  <MegaLink to="/ai-ml-platform">
                    ML &amp; Data Platforms
                  </MegaLink>
                  <MegaLink to="/devops-sre">
                    DevOps, SRE &amp; Observability
                  </MegaLink>
                  <MegaLink to="/application-development">
                ...
                <div>
                  <MegaLink to="/digital-transformation">
                    Digital Transformation
                  </MegaLink>
                  <MegaLink to="/ai-computer-vision">
                    Computer Vision &amp; Edge AI
                  </MegaLink>
                  <MegaLink to="/migration-modernisation">
                    Migration &amp; Modernisation
                  </MegaLink>
                  <MegaLink to="/erp-integration">
            ...
            <MegaItem
              ...
              onToggle={() =>
                setOpenMega(openMega === "products" ? null : "products")
              }
              onClose={closeAll}
              featured
            >
              ...
              <div className="mega-products-layout">
                {(() => {
                  const feat =
                    PRODUCTS.find((p) => p.slug === "admitiq") || PRODUCTS[0];
                  return (
                    <Link
                      to={`/products/${feat.slug}`}
                      className="mega-product-featured"
                      onClick={closeAll}
                    >
                      <div
                        className="mega-product-featured-img"
                        style={{
                          backgroundImage: `url(${feat.cardImage})`,
                          "--product-accent": feat.accent,
                        }}
                      />
                      <div className="mega-product-featured-body">
                        <span className="mega-product-featured-badge">
                          Featured
                        </span>
                        <h5>{feat.name}</h5>
                        <p>{feat.tagline}</p>
                        <span className="mega-product-featured-link">
                          Explore platform →
                        </span>
                      </div>
                    </Link>
                ...
                <div className="mega-products-links">
                  {PRODUCTS.map((p) => (
                    ...
                    >
                      ...
                      <span className="mega-product-link-desc">
                        {p.tagline}
                      </span>
                    </Link>
                  ))}
              ...
              <div className="mega-featured">
                ...
                <p>
                  Voice AI, enterprise agents, admissions, ed-tech,
                  accessibility, and hiring intelligence - full-stack products
                  engineered for production deploy.
                </p>
              </div>
            </MegaItem>
            <MegaItem
              id="ai"
              open={openMega === "ai"}
              onToggle={() => setOpenMega(openMega === "ai" ? null : "ai")}
              onClose={closeAll}
              featured
            >
              ...
              <MegaCols>
                <div>
                  <MegaLink to="/ai-llm-rag" highlight>
                    Generative AI &amp; RAG
                  </MegaLink>
                  <MegaLink to="/ai-agentic">Agentic AI Workflows</MegaLink>
                  <MegaLink to="/ai-ml-platform">
                    ML Scoring &amp; Underwriting
                  </MegaLink>
              ...
              <div className="mega-featured">
                ...
                <p>
                  LegalDST - AI-powered legal research with verified case-law
                  RAG. Built end-to-end by Innovexce.
                </p>
              </div>
            </MegaItem>
            <li className="nav-item">
              <Link to="/ai-hub" className="nav-link-item">
                AI Hub
              </Link>
            </li>
            <MegaItem
              id="insights"
              open={openMega === "insights"}
              onToggle={() =>
                setOpenMega(openMega === "insights" ? null : "insights")
              }
              onClose={closeAll}
            >
            ...
            <MegaItem
              ...
              open={openMega === "about"}
              onToggle={() =>
                setOpenMega(openMega === "about" ? null : "about")
              }
              onClose={closeAll}
            >
              ...
              <MegaCols>
                ...
                <div>
                  ...
                  <a
                    href="http://careers.innovexce.com/careers"
                    target="_blank"
          ...
          <div className="nav-right">
            ...
            <Link
              to="/contact"
              className={`nav-btn${isContact ? " active" : ""}`}
            >
              Contact
            </Link>
                  ...
                  >
                    {LANGUAGES.map((l) => (
                      <button
                        key={l.code}
                        type="button"
                        className={`lang-option${langCode === l.code ? " active" : ""}`}
                ...
                <div className="search-results">
                  {filteredSearch.empty ? (
                    <div className="search-empty">
                      No results for “{searchQuery}”. Try “AI”, “DevOps”, or
                      “Contact”.
                    </div>
                  ) : (
                    Object.entries(filteredSearch.groups).map(
                      ([cat, items]) => (
        ...
        {mobileOpen && (
          ...
          >
            <div className="mob-section">
              <h6>Services</h6>
              <Link to="/ai-hub" onClick={closeAll}>
                Innovexce.AI
              </Link>
              <Link to="/ai-llm-rag" onClick={closeAll}>
                LLM &amp; RAG Engineering
              </Link>
              <Link to="/devops-sre" onClick={closeAll}>
                DevOps &amp; SRE
              </Link>
            ...
            <div className="mob-section">
              <h6>Insights</h6>
              <Link to="/insights" onClick={closeAll}>
                Articles
              </Link>
              <Link to="/casestudies" onClick={closeAll}>
                Case Studies
              </Link>
              <Link to="/whitepapers" onClick={closeAll}>
                Whitepapers
              </Link>
            </div>
            <div className="mob-section">
              ...
              <div className="mob-lang-list">
                {LANGUAGES.map((l) => (
                  <button
                    key={l.code}
                    type="button"
                    className={`mob-lang-btn${langCode === l.code ? " on" : ""}`}
                    onClick={() => selectLang(l.code)}
                  >
                    {l.native}
                  </button>
    ...
    <li className={`nav-item has-mega${open ? " open" : ""}`} data-mega={id}>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div
              className={`mega-inner${featured ? " has-featured" : ""}`}
              onClick={onClose}
            >
              {children}
            </div>
...
function MegaLink({ to, children, highlight }) {
  return (
    <Link to={to} className={highlight ? "highlight" : undefined}>
      {children}
    </Link>
  );
}
