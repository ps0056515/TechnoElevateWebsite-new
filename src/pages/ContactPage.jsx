      ...
      <section className="page-hero bg-theme bg-contact">
        ...
        >
          ...
          <p className="page-hero-lead">
            Whether you have a product idea, a legacy system to modernise, a
            team to scale, or just want to explore - we'd love to hear from you.
          </p>
        </motion.div>
      </section>
        ...
        <div className="wrap">
          ...
          >
            ...
            <motion.div className="c-left" variants={itemLeftVariants}>
              <p className="s-sub">
                Whether you have a product idea, a legacy system to modernise, a
                team to scale, or just want to explore - we'd love to hear from
                you.
              </p>
              <div className="c-points">
                ...
                <div className="c-point">
                  ...
                  <div>
                    <h5>Headquarters</h5>
                    <p>
                      Bengaluru, India - Development unit of TestYantra Software
                      Solutions
                    </p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.div className="fg" variants={formElementVariants}>
                  ...
                  <select name="service" required defaultValue="">
                    ...
                    <option value="Cloud, DevOps & SRE">
                      Cloud, DevOps &amp; SRE
                    </option>
                    <option value="Observability & Platform Engineering">
                      Observability &amp; Platform Engineering
                    </option>
                    <option value="AI & Data Engineering">
                      AI &amp; Data Engineering
                    </option>
                    <option value="Migration & Modernisation">
                      Migration &amp; Modernisation
                    </option>
                    <option value="Digital Transformation">
                      Digital Transformation
                    </option>
                    <option value="ERP & Platform Integration">
                      ERP &amp; Platform Integration
                    </option>
                    <option value="IoT & Edge Computing">
                      IoT &amp; Edge Computing
                    </option>
                ...
                <motion.div className="fg" variants={formElementVariants}>
                  ...
                  <textarea
                    name="message"
                    placeholder="Describe what you're building or the challenge you're solving..."
                    required
                  ></textarea>
                </motion.div>
