...
const SECTIONS = [
  {
    ...
    summary:
      "We collect and process your data transparently to deliver high-quality software engineering services under the TestYantra Group.",
  ...
  },
  {
    ...
    summary:
      "We only collect contact info, project inquiries, job application data, and web analytics. We do not sell your personal data.",
  ...
  },
  {
    ...
    summary:
      "Your information is used strictly to answer inquiries, deliver engineering services, optimize website performance, and maintain security.",
  ...
  },
  {
    ...
    summary:
      "We use essential, analytical, and performance cookies. You can manage or block them through your browser settings.",
  ...
  },
  {
    ...
    summary:
      "We host data on secure, world-class clouds like AWS and Azure. Below is a list of our key subprocessors.",
    ...
    subprocessors: [
      {
        ...
        purpose: "Primary cloud hosting, backups, and secure compute",
        location: "USA & India (Region Locked)",
      },
      {
        name: "Google Cloud Platform (GCP)",
        purpose: "Secure AI models, BigQuery analytics, and API gateway",
        location: "USA",
      },
      {
        name: "HubSpot",
        purpose: "CRM, sales pipeline, and client inquiry tracking",
        location: "USA",
      },
      {
        name: "SendGrid (Twilio)",
        purpose: "Automated notification and transaction transactional emails",
        location: "USA",
      },
    ],
    icon: "☁️",
  },
  {
    ...
    summary:
      "Your data is secured using TLS 1.3 in transit and AES-256 at rest, backed by RBAC and secure software development practices.",
  ...
  },
  {
    ...
    summary:
      "You have full rights to access, update, or delete your data under GDPR, CCPA, and HIPAA privacy rules.",
  ...
  },
  {
    ...
    summary:
      "Have privacy questions? Reach out to our Data Protection Officer at privacy@innovexce.com or contactus@testyantra.com.",
...
export default function PrivacyPage() {
      ...
      rafId = requestAnimationFrame(() => {
        ...
        for (const section of SECTIONS) {
          ...
          if (rect.top <= detectionLine + 10) {
            if (
              rect.top >
              (document.getElementById(closestId)?.getBoundingClientRect()
                .top ?? -Infinity)
            ) {
  ...
  useEffect(() => {
    if (filteredSections.length > 0) {
      const activeIsStillVisible = filteredSections.some(
  ...
  return (
    <>
      ...
      <section
        className="page-hero bg-theme bg-privacy-hero"
      ...
      >
        ...
        >
          ...
          >
            At Innovexce, we embed security, governance, and transparent data
            processing directly into our software engineering practices.
          </motion.p>
          <motion.div
          ...
          >
            ...
            <span className="page-tag privacy-tag-item">
              💡 Transparency First
            </span>
          </motion.div>
        </div>
              ...
              <div className="privacy-sidebar-sticky">
                ...
                <div className="privacy-trust-box">
                  <div className="privacy-trust-header">
                    ...
                    <span className="privacy-trust-title">
                      Security Inquiries
                    </span>
                  </div>
                  <p className="privacy-trust-text">
                    Need our formal data processing addendum (DPA) or security
                    certificates?
                  </p>
            ...
            <main className="privacy-content">
              ...
              <div className="privacy-meta-banner">
                ...
                <div className="meta-right">
                  <span className="status-indicator"></span> Active compliance
                  status
                </div>
              </div>
              ...
              {filteredSections.length === 0 ? (
                <div className="privacy-empty-state">
                  ...
                  <p>
                    Try searching for terms like "cookies", "GDPR", "AWS", or
                    "email".
                  </p>
                  <button
                      ...
                      >
                        ...
                        <div className="privacy-content-card">
                          ...
                          <div className="privacy-card-header">
                            ...
                            <span className="privacy-card-badge">
                              {sec.badge}
                            </span>
                          </div>
                          ...
                          <div
                            className={`privacy-quick-summary-box ${viewMode === "summary" ? "expanded" : ""}`}
                          >
                            <div className="summary-title-row"></div>
                          ...
                          {viewMode === "detailed" && (
                            <div className="privacy-legal-text-wrapper">
                              {sec.legal.split("\n").map((para, pIdx) => {
                                ...
                                return trimmed ? (
                                  <p key={pIdx} className="privacy-legal-para">
                                    {trimmed}
                                  </p>
                                ) : null;
                              })}
                            ...
                            <div className="privacy-faq-accordion">
                              ...
                              <details className="faq-details">
                                ...
                                <div className="faq-content">
                                  <p>
                                    No. Innovexce does not sell, lease, or
                                    monetize personal data to third parties. We
                                    collect data solely to support contract
                                    execution, answer inquiries, and optimize
                                    services.
                                  </p>
                                </div>
                              </details>
                              <details className="faq-details">
                                <summary className="faq-summary">
                                  How do you support HIPAA alignment?
                                </summary>
                                <div className="faq-content">
                                  <p>
                                    For healthcare projects, we sign Business
                                    Associate Agreements (BAAs), isolate patient
                                    data at the network layer, enforce
                                    encryption at rest, and support full
                                    immutable logging audits.
                                  </p>
                                </div>
                              </details>
                            </div>
      ...
      <section
        className="section bg-ink privacy-cta-section"
        style={{ position: "relative", overflow: "hidden" }}
      >
        ...
        <div className="wrap" style={{ position: "relative", zIndex: 2 }}>
          <div className="privacy-cta-grid">
            <div className="cta-left">
              <div className="s-eyebrow" style={{ color: "var(--orange)" }}>
                Data Governance
              </div>
              <h2 className="s-title white">Need more technical details?</h2>
              <p className="s-sub white">
                We are happy to answer any questions about our database
                encryption schemas, secure development environment architecture,
                or specific regional storage protocols.
              </p>
            </div>
            <div className="cta-right">
              <motion.div
                ...
                whileHover={{
                  y: -5,
                  boxShadow: "0 20px 40px rgba(255, 71, 19, 0.15)",
                }}
              >
                <h3>Submit a Security Inquiry</h3>
                <p>
                  Get in touch directly with our internal Data Protection and
                  Compliance team.
                </p>
