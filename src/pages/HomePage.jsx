    ...
    <section className="home-insights-preview">
      <div className="wrap">
        ...
        <div className="home-insights-grid reveal">
          ...
          <Link to="/insight-devops-sre" className="home-insight-card"><div className="home-insight-img" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?auto=format&fit=crop&w=600&q=80')" }} /><div className="home-insight-body"><h4>DevOps &amp; SRE for regulated enterprise workloads</h4><p>SLOs, observability and release discipline when downtime has compliance cost.</p></div></Link>
