...
<div class="nav-mobile" id="navMobile">
  ...
  const SEARCH_INDEX = [
    {
      ...
      href: "index.html",
      cat: "Pages",
      keys: "homepage innovexce ai engineering",
    },
    {
      title: "Contact Us",
      href: "contact.html",
      cat: "Pages",
      keys: "contact email phone get in touch sales",
    },
    {
      title: "About Innovexce",
      href: "about.html",
      cat: "Pages",
      keys: "about company testyantra partner",
    },
    {
      title: "Services",
      href: "services.html",
      cat: "Services",
      keys: "application development cloud devops consulting",
    },
    {
      title: "DevOps, SRE & Observability",
      href: "devops-sre.html",
      cat: "Services",
      keys: "devops sre observability cicd kubernetes prometheus grafana",
    },
    {
      title: "Engagement Models",
      href: "engagement.html",
      cat: "Services",
      keys: "fixed scope t&m bot staff augmentation managed",
    },
    {
      title: "AI Hub",
      href: "ai-hub.html",
      cat: "AI",
      keys: "ai artificial intelligence llm ml rag",
    },
    {
      title: "LLM & RAG Engineering",
      href: "ai-llm-rag.html",
      cat: "AI",
      keys: "generative ai rag llm legaldst",
    },
    {
      title: "Agentic AI Workflows",
      href: "ai-agentic.html",
      cat: "AI",
      keys: "agentic automation agents copilot",
    },
    {
      title: "ML & Data Platforms",
      href: "ai-ml-platform.html",
      cat: "AI",
      keys: "machine learning mlops scoring underwriting",
    },
    {
      title: "Computer Vision & Edge AI",
      href: "ai-computer-vision.html",
      cat: "AI",
      keys: "computer vision retail autonomo edge",
    },
    {
      title: "Products",
      href: "products.html",
      cat: "Products",
      keys: "products ivrai admitiq agentic zupfly accesshub lexiquest interviewiq",
    },
    {
      title: "Industries",
      href: "industries.html",
      cat: "Industries",
      keys: "bfsi telecom automotive healthcare manufacturing",
    },
    {
      title: "BFSI & Fintech",
      href: "industry-bfsi.html",
      cat: "Industries",
      keys: "banking kotak jpmorgan lloyds cars24 fintech",
    },
    {
      title: "Automotive",
      href: "industry-automotive.html",
      cat: "Industries",
      keys: "tekion dms dealership oem automotive",
    },
    {
      title: "Telecom",
      href: "industry-telecom.html",
      cat: "Industries",
      keys: "verizon att wireless telecom bss oss",
    },
    {
      title: "Case Studies",
      href: "casestudies.html",
      cat: "Insights",
      keys: "case studies projects clients outcomes",
    },
    {
      title: "Kotak - Service Request Automation",
      href: "case-study.html?id=kotak-sra",
      cat: "Case Studies",
      keys: "kotak banking automation branch sra",
    },
    {
      title: "LegalDST - AI Legal Research",
      href: "case-study.html?id=legaldst",
      cat: "Case Studies",
      keys: "legaldst legal ai rag case law",
    },
    {
      title: "CARS24 - Credit Underwriting ML",
      href: "case-study.html?id=cars24-credit",
      cat: "Case Studies",
      keys: "cars24 fintech credit scoring ml",
    },
    {
      title: "Verizon MyBiz Platform",
      href: "case-study.html?id=verizon-mybiz",
      cat: "Case Studies",
      keys: "verizon telecom smb microservices sre",
    },
    {
      title: "Tekion Cloud DMS",
      href: "case-study.html?id=tekion-dms",
      cat: "Case Studies",
      keys: "tekion automotive dms cloud kubernetes",
    },
    {
      title: "Insights & Articles",
      href: "insights.html",
      cat: "Insights",
      keys: "blog articles engineering insights",
    },
    {
      title: "Whitepapers & Guides",
      href: "whitepapers.html",
      cat: "Insights",
      keys: "whitepapers guides pdf enterprise ai migration",
    },
    {
      title: "Newsroom",
      href: "newsroom.html",
      cat: "Insights",
      keys: "news announcements press",
    },
    {
      title: "Technology Stack",
      href: "technology.html",
      cat: "Pages",
      keys: "java react aws kubernetes stack",
    },
    {
      title: "Delivery Methodology",
      href: "methodology.html",
      cat: "Company",
      keys: "methodology agile delivery process",
    },
    {
      title: "Leadership",
      href: "leadership.html",
      cat: "Company",
      keys: "leadership team executives",
    },
    {
      title: "Global Locations",
      href: "locations.html",
      cat: "Company",
      keys: "locations bengaluru offices global",
    },
    {
      title: "Security & Compliance",
      href: "security.html",
      cat: "Company",
      keys: "security compliance iso owasp gdpr",
    },
    {
      title: "Careers",
      href: "careers.html",
      cat: "Company",
      keys: "careers jobs hiring devops engineer",
    },
    {
      title: "SRE & Observability Article",
      href: "insight-devops-sre.html",
      cat: "Insights",
      keys: "sre observability microservices prometheus",
    },
    {
      title: "LegalDST RAG Article",
      href: "insight-legaldst-rag.html",
      cat: "Insights",
      keys: "legaldst rag legal ai article",
    },
  ];
  ...
  function initNav() {
    ...
    if (logoLink) {
      logoLink.innerHTML =
        ...
        '" alt="' +
        LOGO_ALT +
        '" class="nav-logo-img" width="180" height="38">';
    }
  ...
  function initSearch(closeMega) {
    ...
    function renderSearch(q) {
      ...
      const items = query
        ...
        : SEARCH_INDEX.filter((item) =>
            ["Pages", "Services", "Products", "AI", "Insights"].includes(
              item.cat,
            ),
          ).slice(0, 8);
      ...
      results.innerHTML = Object.keys(groups)
        .map(
          (cat) =>
            '<div class="search-group"><div class="search-group-label">' +
            cat +
            "</div>" +
            groups[cat]
              .map(
                (item) =>
                  '<a href="' +
                  page(item.href) +
                  '" class="search-result" data-search-link>' +
  ...
  function initLang(closeMega) {
    ...
    dropdown.innerHTML = LANGUAGES.map(
      (lang) =>
        '<button type="button" class="lang-option" role="option" data-lang="' +
        lang.code +
        '">' +
        ...
        "</span>" +
        (lang.code === "en"
          ? '<span class="lang-option-badge">Full site</span>'
          : "") +
        "</button>",
    ).join("");

    if (mobList) {
      mobList.innerHTML = LANGUAGES.map(
        (lang) =>
          '<button type="button" class="mob-lang-btn" data-lang="' +
          lang.code +
          '">' +
          lang.native +
          " <span>(" +
    ...
    function setLanguage(code, closeMenu) {
      ...
      document.getElementById("navLangCode").textContent =
        lang.code.toUpperCase();
  ...
  function updateLanguageNotice(lang) {
    ...
    bar.innerHTML =
      "<span>Site content is currently available in <strong>English</strong>. Selected language: <strong>" +
      esc(lang.native) +
      "</strong>. " +
      '<a href="' +
      page("contact.html") +
      '">Contact us</a> for regional language support.</span>' +
